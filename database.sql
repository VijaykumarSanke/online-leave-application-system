...
-- ============================================================
INSERT INTO leave_applications (student_id, title, leave_type, from_date, to_date, reason, status, faculty_remarks) VALUES
(4, 'Sick Leave Request', 'sick_leave', '2024-03-10', '2024-03-12', 'I have high fever and doctor advised me to rest for 3 days.', 'approved', 'Get well soon. Leave approved.'),
(4, 'Family Function', 'personal_leave', '2024-03-20', '2024-03-21', 'Sister marriage ceremony at hometown.', 'approved', 'Approved. Best wishes to your family.'),
(4, 'Medical Emergency', 'emergency', '2024-04-01', '2024-04-02', 'Accident in family. Need to go to hospital.', 'pending', NULL),
(5, 'Health Issue', 'sick_leave', '2024-03-15', '2024-03-15', 'Severe migraine. Cannot attend classes.', 'rejected', 'Medical certificate not attached. Please reapply with documents.'),
(5, 'Sports Event', 'others', '2024-04-05', '2024-04-07', 'Selected for inter-college cricket tournament.', 'pending', NULL);
